...
The CLI tool is a standalone application that can be used to compare the similarity between images, while the library can be integrated into your own Go projects.
